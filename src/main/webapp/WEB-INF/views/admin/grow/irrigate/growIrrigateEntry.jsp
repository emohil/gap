							...
							<td>
								<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dataList">
								    <tr> 
										...
										<td class=forumrow>
											<input type="text" id="date" name="date" value="${data.disp.date }" class="Wdate" onClick="WdatePicker()"/><font class=required>*</font>
										</td>
								    </tr>
								    <tr>
								    ...
								    <tr>
										...
										<td class=forumrow>
											<input type="text" id="quantum" name="quantum" value="${data.quantum}"/><font class=required>*</font>
										</td>
									</tr>
								    <tr>
