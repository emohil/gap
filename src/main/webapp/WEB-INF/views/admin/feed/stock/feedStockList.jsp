			...
			<tr>
				<td>
					<table border="0" cellspacing="0" cellpadding="0" class="subNav mCenter" style="width:100%;">
			      		<tr>
			        		<td class="font12Blue p10"><span class="font12Blue_B">您当前所在位置：饲料库存</td>
			      		</tr>
			   		 </table>
				</td>
			</tr>
			...
			<tr>
				<td>
					<table cellpadding="0" cellspacing="0" style="width:100%;">
						...
						<tr>
         					 <td class="dataListTitle"><span class="pl10">饲料库存</span></td>
       					</tr>
						<tr>
									...
									<tr>
				              		...
				              		<c:forEach items="${datas}" var="data" varStatus="status">
				              			<tr>
							                ...
							                <td><a href="<%=basePath%>admin/feed/instock/list.html?stockId=${data.id}">入库记录</a></td>
							                <td><a href="<%=basePath%>admin/feed/outstock/list.html?stockId=${data.id}">出库记录</a></td>
							                <td></td>
						              	</tr>
						        	</c:forEach>
								</table>
