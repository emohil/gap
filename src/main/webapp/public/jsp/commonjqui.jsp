<link rel="stylesheet" type="text/css" href="<%=basePath%>public/js/jqueryui/jquery-ui.css" />
...
<script type="text/javascript" src="<%=basePath%>public/js/jqueryui/jquery-ui.js"></script>