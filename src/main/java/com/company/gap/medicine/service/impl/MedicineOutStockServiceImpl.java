...
@Service
public class MedicineOutStockServiceImpl extends BaseServiceImpl<OutStock> implements IMedicineOutStockService {

	@Autowired
	private IMedicineOutStockDao<OutStock> dao;
	@Autowired
