...
@Controller
@RequestMapping("admin/medicine/stock")
public class MedicineStockViewController extends BeanViewController<Stock> {
	...
	protected String viewResolver(HttpServletRequest request, ViewFormModel model) {
		return "admin/medicine/stock/medicineStockList";
	}
}