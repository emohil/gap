...
@Service
public class PesticideOutStockServiceImpl extends BaseServiceImpl<OutStock> implements IPesticideOutStockService {

	@Autowired
	private IPesticideOutStockDao<OutStock> dao;
	@Autowired
