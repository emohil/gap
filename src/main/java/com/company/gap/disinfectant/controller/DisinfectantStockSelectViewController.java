...
@Controller
@RequestMapping("admin/disinfectant/stock/select")
public class DisinfectantStockSelectViewController extends BeanViewController<Stock> {
	...
	protected String viewResolver(HttpServletRequest request, ViewFormModel model) {
		return "admin/disinfectant/stock/disinfectantStockSelectList";
	}
}